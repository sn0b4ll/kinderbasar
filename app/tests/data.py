...
def create_test_data():
    ...
    ## Org Users
    user_id = _create_user(user_id, 'test', 'admin@kinderbasar-elsendorf.de', True, True, False)
    user_id = _create_user(user_id, 'test', 'kasse1@kinderbasar-elsendorf.de', True, True, False)
    user_id = _create_user(user_id, 'test', 'kasse2@kinderbasar-elsendorf.de', True, True, False)
    user_id = _create_user(user_id, 'test', 'kasse3@kinderbasar-elsendorf.de', True, True, False)
